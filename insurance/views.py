...
def admin_dashboard_view(request):
    dict={
        ...
        'total_policy_holder':models.Policy.objects.all().count(),
        'approved_policy_holder':models.Policy.objects.all().filter(status='Approved').count(),
        'disapproved_policy_holder':models.Policy.objects.all().filter(status='Disapproved').count(),
        'waiting_policy_holder':models.Policy.objects.all().filter(status='Pending').count(),
    }
...
def admin_view_policy_holder_view(request):
    policies = models.Policy.objects.all()
    return render(request,'insurance/admin_view_policy_holder.html',{'policies':policies})

def admin_view_approved_policy_holder_view(request):
    policies = models.Policy.objects.all().filter(status='Approved')
    return render(request,'insurance/admin_view_approved_policy_holder.html',{'policies':policies})

def admin_view_disapproved_policy_holder_view(request):
    policies = models.Policy.objects.all().filter(status='Disapproved')
    return render(request,'insurance/admin_view_disapproved_policy_holder.html',{'policies':policies})

def admin_view_waiting_policy_holder_view(request):
    policies = models.Policy.objects.all().filter(status='Pending')
    return render(request,'insurance/admin_view_waiting_policy_holder.html',{'policies':policies})
